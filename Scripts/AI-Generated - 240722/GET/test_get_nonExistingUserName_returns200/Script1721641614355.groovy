...
def authorPayload = '{"idBook": ' + bookId + ', "firstName": "Alice", "lastName": "Johnson"}'
...
def nonExistingUsername = "non_existing_user__unique__"
def userRequest = findTestObject('Object Repository/OR Swagger/FakeRESTApi_Web V1/_api_v1_Users/GET', ['userName': nonExistingUsername])
